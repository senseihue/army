...
<template>
  <client-only>
    <div class="project-category-hero" :style="{ minHeight }">
      ...
      <!--  Content  -->
      <div class="project-category-hero__content container-7xl">
        <h1 class="project-category-hero__content-heading">{{ t("heading") }}</h1>
        <p class="project-category-hero__content-text">{{ t("text") }}</p>
      </div>
    </div>
  </client-only>
</template>
...
<i18n lang="json">
{
  "en": {
    ...
    "text": "Up-to-date information, tools and services to support all stages of project-category implementation in Uzbekistan."
  },
  "ru": {
    "heading": "Для инвесторов",
    "text": "Актуальная информация, инструменты и услуги для поддержки всех этапов реализации проектов в Узбекистане."
  },
  "uz": {
    "heading": "Investorlar uchun",
    "text": "O‘zbekistonda loyihalarni amalga oshirishning barcha bosqichlarini qo‘llab-quvvatlash uchun dolzarb ma’lumotlar, vositalar va xizmatlar."
  }
}
</i18n>
